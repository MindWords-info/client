    ...
    return (
        <>
            ...
            <meta property="og:image"
                  content={`/api/og?image=https://api.mindwords.xyz/files/uploads/${post.data.images?.coverImage || ''}&title=${post.data.title}`}/>
            ...
            <meta name="twitter:image" content={`/api/og?image=https://api.mindwords.xyz/files/uploads/${post.data.images?.coverImage || ''}&title=${post.data.title}`}/>
